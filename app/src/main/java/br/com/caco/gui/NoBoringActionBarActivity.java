...
import br.com.caco.util.AlphaForegroundColorSpan;
import br.com.caco.util.KenBurnsView;
...
public class NoBoringActionBarActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHeaderPicture.setResourceIds(R.drawable.goku, R.drawable.mr_kistch);
