...
public class UserData extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE "+TABLE_NAME_NOTIFICATION+"(_id integer primary key autoincrement, id_user_requester integer, name_user_requester text, img_path text, notif_type text, id_store integer, store_name text);");
